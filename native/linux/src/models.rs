...
impl From<x11rb::errors::ConnectError> for NativeError {
    fn from(value: x11rb::errors::ConnectError) -> Self {
        Self::internal(value.to_string())
    }
}

impl From<x11rb::errors::ConnectionError> for NativeError {
    fn from(value: x11rb::errors::ConnectionError) -> Self {
        Self::internal(value.to_string())
    }
}

impl From<x11rb::errors::ReplyError> for NativeError {
    fn from(value: x11rb::errors::ReplyError) -> Self {
        Self::internal(value.to_string())
    }
}

impl From<x11rb::errors::ParseError> for NativeError {
    fn from(value: x11rb::errors::ParseError) -> Self {
        Self::internal(value.to_string())
    }
}

impl From<atspi::AtspiError> for NativeError {
